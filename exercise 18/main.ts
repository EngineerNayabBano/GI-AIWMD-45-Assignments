...
let placeToVisit:string[]=['paris','italy','london','china','australlia']
//print to orignal order
...
//array is still in its orignal position
...
console.log("sorted in  reverse alphabatical order:",placeToVisit.slice().sort().reverse());
